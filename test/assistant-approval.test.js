...
describe('assistant approvals', () => {
    test('the default is to ask before anything that changes a system', () => {
    ...
    test('every tool declares whether it only reads', () => {
    ...
    test('the tools that change things are not marked read only', () => {
    ...
    test('under "ask every time" nothing runs unattended', () => {
    ...
    test('under the default, reads run and writes stop', () => {
    ...
    test('a plainly read-only command runs without asking', () => {
    ...
    test('a command that only starts with a safe word still asks', () => {
    ...
    test('anything chained, piped or substituted asks, whatever it starts with', () => {
    ...
    test('a second line asks, the same as a semicolon would', () => {
    ...
    test('a single safe command still runs, line endings and all', () => {
    ...
    test('rm -rf is blocked out of the box', () => {
        assert.deepStrictEqual(defaults.blockedCommands, ['rm -rf']);
    });

    test('a blocked command is refused however it is dressed up', () => {
    ...
    test('typing it into the terminal is blocked too', () => {
    ...
    test('a blocked command is refused even when nothing else asks', () => {
    ...
    test('the block list does not swallow commands it was not given', () => {
    ...
    test('a rule may name a wrapper, and reading is not a command', () => {
    ...
    test('an unknown tool is never auto approved', () => {
    ...
    test('"never ask" really does mean never', () => {
    ...
    test('except for what is hard-blocked, which "never ask" does not override', () => {
    ...
    test('a saved host never carries a secret into the model', () => {
    ...
    test('both lists can be edited, emptied and put back', () => {
