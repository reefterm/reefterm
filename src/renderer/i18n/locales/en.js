...
export default {
    ...
    'themeSwitcher.terminalThemeDark': 'Dark',
    'themeSwitcher.terminalThemeLight': 'Light',
    ...
    'settings.terminal.themesDark': 'Dark themes',
    'settings.terminal.themesLight': 'Light themes',
    'settings.terminal.recommended': 'Recommended: {theme}',
